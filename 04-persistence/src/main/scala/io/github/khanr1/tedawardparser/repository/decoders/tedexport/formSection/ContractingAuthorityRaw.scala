...
import io.github.khanr1.tedawardparser.repository.xpath.tedexport.FormSectionPath
      ...
      override def decode(e: Elem): ContractingAuthorityRaw =
        val path = e
          ...
          case Some("FD_CONTRACT_AWARD") =>
            FormSectionPathR208.F03.ContractingAuthorityPath
          case _ =>
            FormSectionPathR208.F15.ContractingAuthorityPath
        ...
        ContractingAuthorityRaw(
          ...
          pointOfContact =
            e.textAtOrError(pointOfContactPath, "Point of Contact"),
    ...
    new XMLDecoder[ContractingAuthorityRaw] {
      ...
      override def decode(e: Elem): ContractingAuthorityRaw =
        val path = e
          ...
          .map(x => x.label) match
          case Some("F03_2014") =>
            FormSectionPathR209.F03.ContractingAuthorityPath
          case _ =>
            FormSectionPathR209.F15.ContractingAuthorityPath
      ...
      override def decode(e: Elem): ContractingAuthorityRaw =
        ...
        ContractingAuthorityRaw(
          ...
          country = e
            ...
            .toRight(
              ParserError.MissingField("Country", Some(path.countryPath.show))
            ),
          pointOfContact =
